...
//! AST1060-EVB Kernelspace Threads Test
//!
//! This test runs multiple kernel threads to verify basic scheduling
//! and thread management on ARMv7-M architecture.
...
impl TargetInterface for Target {
    const NAME: &'static str = "AST1060-EVB Kernelspace Threads";
