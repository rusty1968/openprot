...
fn entry() {
    ...
    // SAFETY: init_bus(2) done above; both buffers are non-cached and owned by this process.
    let master_dma_buf: &'static mut [u8] = unsafe { &mut *core::ptr::addr_of_mut!(MASTER_DMA_BUF) };
