...
use openprot_hal_blocking::digest::{
    DigestInit, DigestOp, DigestCtrlReset, ErrorType, Error, ErrorKind,
    DigestAlgorithm, Sha2_256, Sha2_384, Sha2_512
};
        ...
        impl DigestOp for MockHasher<'_, $algo> {
            ...
            fn finalize(self) -> Result<Self::Output, Self::Error> {
                ...
                for (i, word) in value.iter_mut().enumerate() {
                    *word = 0x12345678u32.wrapping_add(self.data_processed as u32).wrapping_add(i as u32);
                }
